...
public class Wall {
	 ...
	 * 
	 * 
	 * @param extremity1 Extrémité du mur
	 * @param extremity2 Autre extrémité du mur
	 * @param thickness Epaisseur du mur
	 */
	...
	private void computeSommets() {
		sommets[0]
				.translate(
						(int) (-1
								/ (Math.hypot(1,
										extremity1.getX() / extremity1.getY()))
								* thickness / 2),
						(int) (extremity1.getX()
								/ extremity1.getY()
								* 1
		...
		sommets[2]
				.translate(
						(int) (-1
								/ (Math.hypot(1,
										extremity2.getX() / extremity2.getY()))
								* thickness / 2),
						(int) (extremity2.getX()
								/ extremity2.getY()
								* 1
