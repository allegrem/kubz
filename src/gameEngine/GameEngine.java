...
public class GameEngine {
	 ...
	 * de mï¿½me une seule unitï¿½ (Que 3 cubes pour le moment
	 */
	...
	/**
	 * Mï¿½thode qui freeze le jeu, condition de relance sur le mode normal ï¿½ revoir, ï¿½ lancer quand un cube disparait
	 */
	public void frozen(){
	}
