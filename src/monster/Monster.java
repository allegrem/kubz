...
public class Monster {
	...
	/**
	 * reference vers la vue du monstre pour pouvoir transmettre les
	...
	/**
	 * La composante attack va fournir une ArrayList de frequence et
	 * d'intensites qui vont arriver sur le filtre de l'Unit
	 * 
	 * Cette methode prend en compte la distance du monstre au joueur et les
	 * degats decroient en 1/r
	 * 
	 * @param attackTable
	 */
