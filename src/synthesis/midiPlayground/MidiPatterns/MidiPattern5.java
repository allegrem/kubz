...
public class MidiPattern5 extends MidiPattern{
	...
	protected void buildPattern() {
		...
		pattern.add(new DelayedMidiCommand(new MidiCommand(MidiCommand.NOTE_ON, -2, 100), 7f));
		pattern.add(new DelayedMidiCommand(new MidiCommand(MidiCommand.NOTE_OFF, -2, 100), 7.5f));
		
		pattern.add(new DelayedMidiCommand(new MidiCommand(MidiCommand.NOTE_ON, -4, 100), 8f));
		pattern.add(new DelayedMidiCommand(new MidiCommand(MidiCommand.NOTE_OFF, -4, 100), 8.5f));
		
		pattern.add(new DelayedMidiCommand(new MidiCommand(MidiCommand.NOTE_ON, -7, 100), 9f));
		pattern.add(new DelayedMidiCommand(new MidiCommand(MidiCommand.NOTE_OFF, -7, 100), 9.5f));
