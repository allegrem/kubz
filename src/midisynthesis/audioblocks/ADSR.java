 ...
 * recommended to plug a {@link Constant} or a {@link MidiParam} in (since
 * their value won't change).
 * 
 * @author allegrem
 */
public class ADSR implements MidiAudioBlock {
	...
	/**
	 * Create a new ADSR object. The four parameters should be
	 * {@link Constant} or {@link MidiParam} (since their value won't
	 * change).
	 * 
	 * @param a
	 ...
	 */
	public ADSR(MidiAudioBlock a, MidiAudioBlock d, MidiAudioBlock s,
			MidiAudioBlock r) {
		super();
		this.a = a;
		this.d = d;
	...
	public Float phi(Float t) {
		...
		System.out.println("ERROR! phi function not implemented in ADSR!!");
		return null;
	}
