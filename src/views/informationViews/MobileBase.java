...
public class MobileBase implements DisplayableChild{
	...
	public void paint() {
		...
		/*for (int i=1;i<4;i++){					
			int alpha = Math.round( ((4-i)/4) *255);			
			GL11.glColor4ub((byte) (Color.red.getRed()+40*i^2),(byte) Color.green.getGreen(),(byte) Color.green.getBlue(),(byte) alpha );
			disks[i].draw(30+10*(i-1),30+10*i,50,1);		
		} //Ca marche pas avec les alpha, me met 0 a chaque fois :'(
		*/
